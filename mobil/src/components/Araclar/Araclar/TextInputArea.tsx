...
import { KeyboardType, StyleSheet, View, TextInput, Text } from 'react-native'
import { AutoCapitalizeType } from './TextInputBox'
...
export default class TextInputArea extends Component<Props, State> {
    state = {}
